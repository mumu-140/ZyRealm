...
export function ActiveRequests() {
    ...
    return (
        <section className="shrink-0 rounded-lg border bg-card/60 px-3 py-2.5" aria-label="Active Requests">
            ...
            <div className="mt-2 max-h-72 divide-y overflow-y-auto">
                    ...
                    return (
                        ...
                        >
                            ...
                            <Button
                                ...
                                onClick={() => interrupt.mutate(request.request_id)}
                            >
                                {interruptingThis ? (
